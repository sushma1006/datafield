...
function Deals(width, height, color) {
    return (
        ...
        >
            ...
            />
            <path 
                d="M17 3V7H21" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"
            />
            <path 
                d="M22 2L17 7" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"
            />
        </svg>
    );
}
